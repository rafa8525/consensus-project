...
# ---- CONFIG ----
SHEET_ID = '1Xn9GB_GJtJmU1fI4kc7mdsvuz6xGzo2oFU8_YdkwGAQ'  # Change if you rename/move sheet
    ...
    for idx, row in enumerate(rows):
        ...
        if status.lower() == 'pending':
            ...
            if last_notified.strip():
                try:
                    notified_dt = tz.localize(datetime.datetime.strptime(last_notified, "%Y-%m-%d %H:%M"))
                except Exception:
                    pass
