...
commit_message = "📤 Upload or update kitchen_log.md via GitHub API"
...
# Step 1: Attempt to fetch the SHA if the file already exists
sha = None
try:
    ...
    print(f"Warning: SHA lookup failed – {e}")
