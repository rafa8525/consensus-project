...
def send_reminder(message=None):
    try:
        ...
        twilio_msg = send_sms(to=TO_NUMBER, from_=TWILIO_FROM_NUMBER, body=message)
...
md_log = (
    f"/home/rafa1215/consensus-project/memory/logs/reminders/fallback_log_{log_date}.md"
)
