...
run_command(
    "python3 /home/rafa1215/consensus-project/memory_auto_commit_merged.py",
    "Memory Auto Commit",
)
...
run_command(
    "python3 /home/rafa1215/consensus-project/backup_to_gdrive.py",
    "Google Drive Backup",
)

# Step 4: Barcode sheet updater
run_command(
    "python3 /home/rafa1215/consensus-project/push_upc_corrections.py",
    "Barcode Sheet Auto-Update",
)
